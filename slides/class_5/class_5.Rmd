...
Para transformar un data frame en tibble usamos la función `as_tibble()`. Continuándo con el ejemplo anterior, así se ven los datos de la encuenta Casen 2017 en formato `data.frame()`:
